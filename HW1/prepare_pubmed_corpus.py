...
try:
    dataset = load_dataset("ccdv/pubmed-summarization", "document", trust_remote_code=True)
except Exception as e:
    print(f"Error loading dataset. Please check your internet connection or disk space. Error: {e}")
    sys.exit()
