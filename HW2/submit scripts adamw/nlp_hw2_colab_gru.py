...
hidden_dim = calculate_hidden_dim(
    rnn_type="GRU", embed_dim=embed_dim, vocab_size=vocab_size
)
...
i = 0
print(
    f"GRU w/ {sum(p.numel() for p in model.parameters() if p.requires_grad)} trainable params + Original Dataset"
)
