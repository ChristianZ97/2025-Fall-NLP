...
Original file is located at
    https://colab.research.google.com/drive/19FVV1oAyzzR9t0G9PtO7bq_MOviJxN6W
"""
...
i = 0
print(
    f"LSTM w/ {sum(p.numel() for p in model.parameters() if p.requires_grad)} trainable params + Original Dataset (AdamW)"
)
