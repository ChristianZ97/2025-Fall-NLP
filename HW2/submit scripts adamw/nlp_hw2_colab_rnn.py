# -*- coding: utf-8 -*-
"""nlp_hw2_colab_rnn.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SfyTGjMhK3tOqPDfpxRze1jzXQI6_m_6
"""
...
hidden_dim = calculate_hidden_dim(
    rnn_type="RNN", embed_dim=embed_dim, vocab_size=vocab_size
)
...
i = 0
print(
    f"RNN w/ {sum(p.numel() for p in model.parameters() if p.requires_grad)} trainable params + Original Dataset"
)
